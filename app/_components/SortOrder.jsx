    ...
    return (
        <div className="relative w-full sm:w-auto">
            <select
                ...
                className="w-full sm:w-auto sm:min-w-[120px] appearance-none bg-surface-high border border-outline-variant/30 text-on-surface-variant hover:text-on-surface hover:border-outline-variant/60 rounded-lg text-xs font-semibold py-2 px-3 pr-9 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all duration-200 cursor-pointer"
            >
                <option value="desc" className="bg-surface-high text-on-surface">Descending</option>
                <option value="asc" className="bg-surface-high text-on-surface">Ascending</option>
            </select>
